...
public class BigDecimalBooleanConverterDiffblueTest {
  ...
  public void convertToExcelDataTest() {
    ...
    // Act
    CellData actualConvertToExcelDataResult = bigDecimalBooleanConverter.convertToExcelData(null, contentProperty,
  ...
  public void supportExcelTypeKeyTest() {
    ...
    assertEquals(CellDataTypeEnum.BOOLEAN, (new BigDecimalBooleanConverter()).supportExcelTypeKey());
  }
}
