...
class ReadBasicParameterTest {
    ...
    void factory() {
        ...
        assertThat(readBasicParameter.getCustomReadListenerList(), hasSize(1));
        ...
        assertThat(readBasicParameter.getCustomConverterList(), hasSize(1));
        assertThat(readBasicParameter.getCustomConverterList().get(0), is(notNullValue()));
        assertThat(readBasicParameter.getHead(), hasSize(1));
        assertThat(readBasicParameter.getHead().get(0), equalTo(Arrays.asList("foo")));
