...
class ReadWorkbookTest {
    ...
    void factory() {
        ...
        assertThat(readWorkbook.getCustomReadListenerList(), hasSize(1));
        ...
        assertThat(readWorkbook.getCustomConverterList(), hasSize(1));
        assertThat(readWorkbook.getCustomConverterList().get(0), is(notNullValue()));
        assertThat(readWorkbook.getHead(), hasSize(1));
        assertThat(readWorkbook.getHead().get(0), equalTo(Arrays.asList("foo")));
