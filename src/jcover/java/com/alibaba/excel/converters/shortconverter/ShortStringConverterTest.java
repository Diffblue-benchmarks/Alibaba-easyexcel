...
/**
 * Unit tests for com.alibaba.excel.converters.shortconverter.ShortStringConverter
 *
...
public class ShortStringConverterTest {
    ...
    public void convertToExcelDataValueIsOne() {
        CellData result = new ShortStringConverter().convertToExcelData((short)1, new ExcelContentProperty(), new GlobalConfiguration());
    ...
    public void supportJavaTypeKeyReturnsShort() {
        assertThat(new ShortStringConverter().supportJavaTypeKey(), equalTo((Class)Short.class));
    }
}
