...
class WriteWorkbookTest {
    ...
    void factory() {
        ...
        assertThat(writeWorkbook.getCustomWriteHandlerList(), hasSize(1));
        ...
        assertThat(writeWorkbook.getExcludeColumnFiledNames().contains("data.txt"), is(true));
        assertThat(writeWorkbook.getExcludeColumnIndexes(), hasSize(1));
        assertThat(writeWorkbook.getExcludeColumnIndexes().contains(1), is(true));
        assertThat(writeWorkbook.getIncludeColumnFiledNames(), hasSize(1));
        assertThat(writeWorkbook.getIncludeColumnFiledNames().contains("data.txt"), is(true));
        assertThat(writeWorkbook.getIncludeColumnIndexes(), hasSize(1));
        assertThat(writeWorkbook.getIncludeColumnIndexes().contains(1), is(true));
        ...
        assertThat(writeWorkbook.getCustomConverterList(), hasSize(1));
        assertThat(writeWorkbook.getCustomConverterList().get(0), is(notNullValue()));
        assertThat(writeWorkbook.getHead(), hasSize(1));
        assertThat(writeWorkbook.getHead().get(0), equalTo(Arrays.asList("foo")));
