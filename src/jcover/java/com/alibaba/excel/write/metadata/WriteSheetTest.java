...
class WriteSheetTest {
    ...
    void factory() {
        ...
        assertThat(writeSheet.getColumnWidthMap(), anEmptyMap());
        ...
        assertThat(writeSheet.getCustomWriteHandlerList(), hasSize(1));
        ...
        assertThat(writeSheet.getExcludeColumnFiledNames().contains("data.txt"), is(true));
        assertThat(writeSheet.getExcludeColumnIndexes(), hasSize(1));
        assertThat(writeSheet.getExcludeColumnIndexes().contains(1), is(true));
        assertThat(writeSheet.getIncludeColumnFiledNames(), hasSize(1));
        assertThat(writeSheet.getIncludeColumnFiledNames().contains("data.txt"), is(true));
        assertThat(writeSheet.getIncludeColumnIndexes(), hasSize(1));
        assertThat(writeSheet.getIncludeColumnIndexes().contains(1), is(true));
        ...
        assertThat(writeSheet.getCustomConverterList(), hasSize(1));
        assertThat(writeSheet.getCustomConverterList().get(0), is(notNullValue()));
        assertThat(writeSheet.getHead(), hasSize(1));
        assertThat(writeSheet.getHead().get(0), equalTo(Arrays.asList("foo")));
