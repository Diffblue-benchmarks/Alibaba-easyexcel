...
class WriteBasicParameterTest {
    ...
    void factory() {
        ...
        assertThat(writeBasicParameter.getCustomWriteHandlerList(), hasSize(1));
        ...
        assertThat(writeBasicParameter.getExcludeColumnFiledNames().contains("data.txt"), is(true));
        assertThat(writeBasicParameter.getExcludeColumnIndexes(), hasSize(1));
        assertThat(writeBasicParameter.getExcludeColumnIndexes().contains(1), is(true));
        assertThat(writeBasicParameter.getIncludeColumnFiledNames(), hasSize(1));
        assertThat(writeBasicParameter.getIncludeColumnFiledNames().contains("data.txt"), is(true));
        assertThat(writeBasicParameter.getIncludeColumnIndexes(), hasSize(1));
        assertThat(writeBasicParameter.getIncludeColumnIndexes().contains(1), is(true));
        ...
        assertThat(writeBasicParameter.getCustomConverterList(), hasSize(1));
        assertThat(writeBasicParameter.getCustomConverterList().get(0), is(notNullValue()));
        assertThat(writeBasicParameter.getHead(), hasSize(1));
        assertThat(writeBasicParameter.getHead().get(0), equalTo(Arrays.asList("foo")));
