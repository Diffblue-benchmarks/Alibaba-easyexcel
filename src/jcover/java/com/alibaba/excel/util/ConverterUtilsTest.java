...
class ConverterUtilsTest {
    ...
    @Test
    void convertToStringMapReturnsNullSomething1() throws Exception {
        ...
        // assert
        assertThat(result.get(0), is(nullValue()));
        assertThat(result.get(1), is("something"));
    }

    @Test
    void convertToStringMapReturnsNullSomething2() throws Exception {
