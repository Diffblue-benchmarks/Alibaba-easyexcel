...
class ExcelHeadPropertyTest {
    ...
    void factory() {
        ...
        assertThat(excelHeadProperty.getContentPropertyMap().isEmpty(), is(true));
        assertThat(excelHeadProperty.getFieldNameContentPropertyMap().isEmpty(), is(true));
        ...
        assertThat(excelHeadProperty.getHeadMap().isEmpty(), is(true));
