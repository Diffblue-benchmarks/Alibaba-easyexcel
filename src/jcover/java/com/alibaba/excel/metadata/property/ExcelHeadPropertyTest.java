...
class ExcelHeadPropertyTest {
    ...
    void factory() {
        ...
        x409.setDateTimeFormatProperty(dateTimeFormatProperty1);
        ...
        x409.setNumberFormatProperty(numberFormatProperty1);
        contentPropertyMap.put(1, x409);
        ...
        ExcelContentProperty x470 = new ExcelContentProperty();
        x470.setConverter(new AutoConverter());
        ...
        x470.setDateTimeFormatProperty(dateTimeFormatProperty3);
        ...
        x470.setNumberFormatProperty(numberFormatProperty3);
        fieldNameContentPropertyMap.put("foo", x470);
        ...
        Head x533 = new Head(1, "data", headNameList9, false, false);
        x533.setColumnIndex(1);
        ColumnWidthProperty columnWidthProperty1 = new ColumnWidthProperty(1);
        columnWidthProperty1.setWidth(1);
        x533.setColumnWidthProperty(columnWidthProperty1);
        x533.setFieldName("data");
        x533.setForceIndex(false);
        x533.setForceName(false);
        ArrayList<String> headNameList10 = new ArrayList<String>();
        headNameList10.add("Smith");
        x533.setHeadNameList(headNameList10);
        headMap.put(1, x533);
        ...
        assertThat(excelHeadProperty.getContentPropertyMap().get(1), sameInstance(x409));
        assertThat(excelHeadProperty.getFieldNameContentPropertyMap().get("foo"), sameInstance(x470));
        ...
        assertThat(excelHeadProperty.getHeadMap().get(1), sameInstance(x533));
