...
class ExcelWriterTest {
    ...
    @Test
    void writeDataIsEmpty() {
        ExcelWriter excelWriter =
             new ExcelWriter(new GenerateParam("name", String.class, new ByteArrayOutputStream()));
        assertThat(excelWriter.write(new ArrayList<String>(), new Sheet(1)), sameInstance(excelWriter));
    }

    @Test
    void write0DataIsEmpty() {
        ExcelWriter excelWriter =
             new ExcelWriter(new GenerateParam("name", String.class, new ByteArrayOutputStream()));
        assertThat(excelWriter.write0(new ArrayList<String>(), new Sheet(1)), sameInstance(excelWriter));
    }

    @Test
    void write1DataIsEmpty() {
        ExcelWriter excelWriter =
             new ExcelWriter(new GenerateParam("name", String.class, new ByteArrayOutputStream()));
        assertThat(excelWriter.write1(new ArrayList<String>(), new Sheet(1)), sameInstance(excelWriter));
    }
