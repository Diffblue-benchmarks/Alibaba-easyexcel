...
public class ReadWorkbook_setCustomObjectTest_11_Test {
  @Test
  public void setCustomObjectTest() throws Exception {
    // Arrange
    ...
    Object customObject1 = readWorkbook.getCustomObject();
    Assert.assertEquals(null, excelType);
    Assert.assertTrue(customObject1 instanceof String);
    Assert.assertEquals(null, customConverterList);
    Assert.assertEquals("aaaaa", customObject1);
