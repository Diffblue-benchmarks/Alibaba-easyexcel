...
public class ReadWorkbook_setIgnoreEmptyRowTest_21_Test {
  @Test
  public void setIgnoreEmptyRowTest() throws Exception {
    // Arrange
    ...
    Boolean ignoreEmptyRow1 = readWorkbook.getIgnoreEmptyRow();
    ...
    Assert.assertEquals(Boolean.valueOf(true), ignoreEmptyRow1);
