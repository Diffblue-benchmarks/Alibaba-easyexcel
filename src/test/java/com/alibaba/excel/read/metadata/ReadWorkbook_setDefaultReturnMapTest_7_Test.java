...
public class ReadWorkbook_setDefaultReturnMapTest_7_Test {
  @Test
  public void setDefaultReturnMapTest() throws Exception {
    // Arrange
    ReadWorkbook readWorkbook = new ReadWorkbook();
    Boolean defaultReturnMap = new Boolean(true);
    ...
    Boolean defaultReturnMap1 = readWorkbook.getDefaultReturnMap();
    ...
    Assert.assertEquals(Boolean.valueOf(true), defaultReturnMap1);
