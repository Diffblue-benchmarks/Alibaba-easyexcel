...
public class WriteCellStyle_setRotationTest_3_Test {
  @Test
  public void setRotationTest() throws Exception {
    // Arrange
    WriteCellStyle writeCellStyle = new WriteCellStyle();
    Short rotation = new Short((short) 1);

    // Act
    writeCellStyle.setRotation(rotation);
    ...
    Short rotation1 = writeCellStyle.getRotation();
    ...
    Assert.assertEquals(Short.valueOf((short) 1), rotation1);
