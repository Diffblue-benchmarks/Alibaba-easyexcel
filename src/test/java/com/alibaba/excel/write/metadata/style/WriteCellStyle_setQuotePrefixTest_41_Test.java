...
public class WriteCellStyle_setQuotePrefixTest_41_Test {
  @Test
  public void setQuotePrefixTest() throws Exception {
    // Arrange
    WriteCellStyle writeCellStyle = new WriteCellStyle();
    Boolean quotePrefix = new Boolean(true);

    // Act
    writeCellStyle.setQuotePrefix(quotePrefix);
    ...
    Boolean quotePrefix1 = writeCellStyle.getQuotePrefix();
    ...
    Assert.assertEquals(Boolean.valueOf(true), quotePrefix1);
