...
public class WriteCellStyle_setTopBorderColorTest_38_Test {
  @Test
  public void setTopBorderColorTest() throws Exception {
    // Arrange
    WriteCellStyle writeCellStyle = new WriteCellStyle();
    Short topBorderColor = new Short((short) 1);

    // Act
    writeCellStyle.setTopBorderColor(topBorderColor);
    ...
    Short topBorderColor1 = writeCellStyle.getTopBorderColor();
    ...
    Assert.assertEquals(Short.valueOf((short) 1), topBorderColor1);
