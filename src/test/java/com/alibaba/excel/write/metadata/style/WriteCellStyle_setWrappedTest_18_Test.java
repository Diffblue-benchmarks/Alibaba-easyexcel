...
public class WriteCellStyle_setWrappedTest_18_Test {
  @Test
  public void setWrappedTest() throws Exception {
    // Arrange
    WriteCellStyle writeCellStyle = new WriteCellStyle();
    Boolean wrapped = new Boolean(true);
