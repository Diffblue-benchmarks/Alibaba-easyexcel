...
public class WriteCellStyle_setLockedTest_35_Test {
  @Test
  public void setLockedTest() throws Exception {
    // Arrange
    WriteCellStyle writeCellStyle = new WriteCellStyle();
    Boolean locked = new Boolean(true);
    ...
    Boolean locked1 = writeCellStyle.getLocked();
    ...
    Assert.assertEquals(Boolean.valueOf(true), locked1);
