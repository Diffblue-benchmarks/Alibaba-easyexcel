...
public class WriteCellStyle_setFillPatternTypeTest_14_Test {
  @Test
  public void setFillPatternTypeTest() throws Exception {
    // Arrange
    WriteCellStyle writeCellStyle = new WriteCellStyle();
    FillPatternType fillPatternType = FillPatternType.NO_FILL;

    // Act
    writeCellStyle.setFillPatternType(fillPatternType);
    ...
    FillPatternType fillPatternType1 = writeCellStyle.getFillPatternType();
    ...
    Assert.assertEquals(FillPatternType.NO_FILL, fillPatternType1);
