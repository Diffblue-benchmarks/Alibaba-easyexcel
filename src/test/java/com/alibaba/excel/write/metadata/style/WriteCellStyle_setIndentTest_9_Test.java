...
public class WriteCellStyle_setIndentTest_9_Test {
  @Test
  public void setIndentTest() throws Exception {
    // Arrange
    WriteCellStyle writeCellStyle = new WriteCellStyle();
    Short indent = new Short((short) 1);
    ...
    Short indent1 = writeCellStyle.getIndent();
    ...
    Assert.assertEquals(Short.valueOf((short) 1), indent1);
