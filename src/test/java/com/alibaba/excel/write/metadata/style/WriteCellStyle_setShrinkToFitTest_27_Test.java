...
public class WriteCellStyle_setShrinkToFitTest_27_Test {
  @Test
  public void setShrinkToFitTest() throws Exception {
    // Arrange
    WriteCellStyle writeCellStyle = new WriteCellStyle();
    Boolean shrinkToFit = new Boolean(true);

    // Act
    writeCellStyle.setShrinkToFit(shrinkToFit);
    ...
    Boolean shrinkToFit1 = writeCellStyle.getShrinkToFit();
    ...
    Assert.assertEquals(Boolean.valueOf(true), shrinkToFit1);
