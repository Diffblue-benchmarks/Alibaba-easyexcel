...
public class WriteCellStyle_setHiddenTest_34_Test {
  @Test
  public void setHiddenTest() throws Exception {
    // Arrange
    WriteCellStyle writeCellStyle = new WriteCellStyle();
    Boolean hidden = new Boolean(true);

    // Act
    writeCellStyle.setHidden(hidden);
    ...
    Boolean hidden1 = writeCellStyle.getHidden();
    ...
    Assert.assertEquals(Boolean.valueOf(true), hidden1);
