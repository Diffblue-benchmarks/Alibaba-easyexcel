...
public class WriteCellStyle_setBorderLeftTest_20_Test {
  @Test
  public void setBorderLeftTest() throws Exception {
    // Arrange
    WriteCellStyle writeCellStyle = new WriteCellStyle();
    BorderStyle borderLeft = BorderStyle.NONE;

    // Act
    writeCellStyle.setBorderLeft(borderLeft);
    ...
    BorderStyle borderLeft1 = writeCellStyle.getBorderLeft();
    ...
    Assert.assertEquals(BorderStyle.NONE, borderLeft1);
