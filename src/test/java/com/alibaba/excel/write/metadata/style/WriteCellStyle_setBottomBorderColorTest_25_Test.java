...
public class WriteCellStyle_setBottomBorderColorTest_25_Test {
  @Test
  public void setBottomBorderColorTest() throws Exception {
    // Arrange
    WriteCellStyle writeCellStyle = new WriteCellStyle();
    Short bottomBorderColor = new Short((short) 1);

    // Act
    writeCellStyle.setBottomBorderColor(bottomBorderColor);
    ...
    Short bottomBorderColor1 = writeCellStyle.getBottomBorderColor();
    ...
    Assert.assertEquals(Short.valueOf((short) 1), bottomBorderColor1);
