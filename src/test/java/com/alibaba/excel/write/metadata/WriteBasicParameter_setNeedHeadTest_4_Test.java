...
public class WriteBasicParameter_setNeedHeadTest_4_Test {
  @Test
  public void setNeedHeadTest() throws Exception {
    ...
    // Act
    writeBasicParameter.setNeedHead(needHead);
    ...
    Boolean needHead1 = writeBasicParameter.getNeedHead();
    ...
    Assert.assertEquals(Boolean.valueOf(true), needHead1);
