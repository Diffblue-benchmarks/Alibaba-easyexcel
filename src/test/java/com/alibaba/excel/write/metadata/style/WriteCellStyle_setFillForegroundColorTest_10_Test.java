...
public class WriteCellStyle_setFillForegroundColorTest_10_Test {
  @Test
  public void setFillForegroundColorTest() throws Exception {
    // Arrange
    WriteCellStyle writeCellStyle = new WriteCellStyle();
    Short fillForegroundColor = new Short((short) 1);
    ...
    Short fillForegroundColor1 = writeCellStyle.getFillForegroundColor();
    ...
    Assert.assertEquals(Short.valueOf((short) 1), fillForegroundColor1);
