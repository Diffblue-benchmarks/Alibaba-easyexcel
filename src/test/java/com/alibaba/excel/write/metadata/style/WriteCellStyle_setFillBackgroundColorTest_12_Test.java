...
public class WriteCellStyle_setFillBackgroundColorTest_12_Test {
  @Test
  public void setFillBackgroundColorTest() throws Exception {
    // Arrange
    WriteCellStyle writeCellStyle = new WriteCellStyle();
    Short fillBackgroundColor = new Short((short) 1);

    // Act
    writeCellStyle.setFillBackgroundColor(fillBackgroundColor);
    ...
    Assert.assertEquals(Short.valueOf((short) 1), writeCellStyle.getFillBackgroundColor());
