...
public class WriteCellStyle_setBorderTopTest_16_Test {
  @Test
  public void setBorderTopTest() throws Exception {
    // Arrange
    WriteCellStyle writeCellStyle = new WriteCellStyle();
    BorderStyle borderTop = BorderStyle.NONE;

    // Act
    writeCellStyle.setBorderTop(borderTop);

    // Assert
    WriteFont writeFont = writeCellStyle.getWriteFont();
    BorderStyle borderTop1 = writeCellStyle.getBorderTop();
    ...
    Assert.assertEquals(BorderStyle.NONE, borderTop1);
  }
  @org.junit.Rule
