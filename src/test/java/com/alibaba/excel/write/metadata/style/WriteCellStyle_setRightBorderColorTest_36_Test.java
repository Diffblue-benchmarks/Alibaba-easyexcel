...
public class WriteCellStyle_setRightBorderColorTest_36_Test {
  @Test
  public void setRightBorderColorTest() throws Exception {
    // Arrange
    WriteCellStyle writeCellStyle = new WriteCellStyle();
    Short rightBorderColor = new Short((short) 1);

    // Act
    writeCellStyle.setRightBorderColor(rightBorderColor);
    ...
    Short rightBorderColor1 = writeCellStyle.getRightBorderColor();
    ...
    Assert.assertEquals(Short.valueOf((short) 1), rightBorderColor1);
