...
public class SimpleRowHeightStyleStrategy_setHeadColumnHeightTest_1_Test {
  @Test
  public void setHeadColumnHeightTest() throws Exception {
    // Arrange
    ...
    simpleRowHeightStyleStrategy.setHeadColumnHeight(row, relativeRowIndex);
  }
  @Rule
