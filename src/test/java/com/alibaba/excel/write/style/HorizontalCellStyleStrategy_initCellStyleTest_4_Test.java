...
public class HorizontalCellStyleStrategy_initCellStyleTest_4_Test {
//failed_pass   @Test
//  public void initCellStyleTest() throws Exception {
//    // Arrange
...
//
//    // Act
//    horizontalCellStyleStrategy.initCellStyle(hSSFWorkbook);
//
//    // Assert
...
//    Assert.assertEquals(1660, bytes.length);
//    Assert.assertEquals((byte) 9, bytes[0]);
//    Assert.assertEquals((byte) 8, bytes[1]);
//    Assert.assertEquals((byte) 16, bytes[2]);
//    Assert.assertEquals((byte) 0, bytes[1657]);
//    Assert.assertEquals((byte) 0, bytes[1658]);
//    Assert.assertEquals((byte) 0, bytes[1659]);
...
//    Assert.assertEquals((short) 5, numberOfFonts);
//    Assert.assertEquals(23, numCellStyles);
...
//    Assert.assertEquals(75, numRecords);
//    Assert.assertTrue(formats instanceof java.util.ArrayList);
//    Assert.assertEquals(23, numExFormats);
//    Assert.assertEquals(5, numberOfFontRecords);
