...
public class HorizontalCellStyleStrategy_setHeadCellStyleTest_2_Test {
  @Test
  public void setHeadCellStyleTest() throws Exception {
    // Arrange
    ...
    // Act
    horizontalCellStyleStrategy.setHeadCellStyle(hSSFCell, head, relativeRowIndex);
