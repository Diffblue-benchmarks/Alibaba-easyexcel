...
public class ExcelHeadProperty_setHeadKindTest_2_Test {
  @Test
  public void setHeadKindTest() throws Exception {
    // Arrange
    ...
    HeadKindEnum headKind = HeadKindEnum.NONE;

    // Act
    excelHeadProperty.setHeadKind(headKind);

    // Assert
    HeadKindEnum headKind1 = excelHeadProperty.getHeadKind();
    ...
    Assert.assertEquals(HeadKindEnum.NONE, headKind1);
