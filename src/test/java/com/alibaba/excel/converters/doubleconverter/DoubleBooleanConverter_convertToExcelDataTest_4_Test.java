...
public class DoubleBooleanConverter_convertToExcelDataTest_4_Test {
  @Test
  public void convertToExcelDataTest() throws Exception {
    ...
    // Act
    CellData actual = doubleBooleanConverter.convertToExcelData(value, contentProperty, globalConfiguration);
