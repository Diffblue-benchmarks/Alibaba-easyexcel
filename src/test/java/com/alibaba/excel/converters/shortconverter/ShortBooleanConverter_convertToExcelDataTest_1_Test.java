...
public class ShortBooleanConverter_convertToExcelDataTest_1_Test {
  @Test
  public void convertToExcelDataTest() throws Exception {
    ...
    // Act
    CellData actual = shortBooleanConverter.convertToExcelData(value, contentProperty, globalConfiguration);
