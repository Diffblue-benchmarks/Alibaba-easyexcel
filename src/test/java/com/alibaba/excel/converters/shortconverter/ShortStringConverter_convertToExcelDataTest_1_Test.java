...
public class ShortStringConverter_convertToExcelDataTest_1_Test {
  @Test
  public void convertToExcelDataTest() throws Exception {
    ...
    // Act
    CellData actual = shortStringConverter.convertToExcelData(value, contentProperty, globalConfiguration);
