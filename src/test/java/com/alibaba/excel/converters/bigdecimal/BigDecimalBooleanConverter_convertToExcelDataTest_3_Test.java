...
public class BigDecimalBooleanConverter_convertToExcelDataTest_3_Test {
  @Test
  public void convertToExcelDataTest() throws Exception {
    ...
    // Act
    CellData actual = bigDecimalBooleanConverter.convertToExcelData(value, contentProperty, globalConfiguration);
