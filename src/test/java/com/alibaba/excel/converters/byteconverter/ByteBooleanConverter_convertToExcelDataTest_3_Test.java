...
public class ByteBooleanConverter_convertToExcelDataTest_3_Test {
  @Test
  public void convertToExcelDataTest() throws Exception {
    ...
    // Act
    CellData actual = byteBooleanConverter.convertToExcelData(value, contentProperty, globalConfiguration);
