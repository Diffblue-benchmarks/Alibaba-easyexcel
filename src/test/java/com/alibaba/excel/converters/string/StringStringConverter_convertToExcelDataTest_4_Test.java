...
public class StringStringConverter_convertToExcelDataTest_4_Test {
  @Test
  public void convertToExcelDataTest() throws Exception {
    ...
    // Act
    CellData actual = stringStringConverter.convertToExcelData(value, contentProperty, globalConfiguration);
