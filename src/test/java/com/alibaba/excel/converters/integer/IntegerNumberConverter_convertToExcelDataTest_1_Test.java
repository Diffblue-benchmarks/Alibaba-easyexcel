...
public class IntegerNumberConverter_convertToExcelDataTest_1_Test {
  @Test
  public void convertToExcelDataTest() throws Exception {
    ...
    // Act
    CellData actual = integerNumberConverter.convertToExcelData(value, contentProperty, globalConfiguration);
