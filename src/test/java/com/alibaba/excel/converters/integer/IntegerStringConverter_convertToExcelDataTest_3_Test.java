...
public class IntegerStringConverter_convertToExcelDataTest_3_Test {
  @Test
  public void convertToExcelDataTest() throws Exception {
    ...
    // Act
    CellData actual = integerStringConverter.convertToExcelData(value, contentProperty, globalConfiguration);
