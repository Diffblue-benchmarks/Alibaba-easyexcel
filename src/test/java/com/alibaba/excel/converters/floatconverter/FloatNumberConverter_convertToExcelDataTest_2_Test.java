...
public class FloatNumberConverter_convertToExcelDataTest_2_Test {
  @Test
  public void convertToExcelDataTest() throws Exception {
    ...
    // Act
    CellData actual = floatNumberConverter.convertToExcelData(value, contentProperty, globalConfiguration);
