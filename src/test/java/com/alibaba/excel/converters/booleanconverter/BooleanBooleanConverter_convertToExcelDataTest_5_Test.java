...
public class BooleanBooleanConverter_convertToExcelDataTest_5_Test {
  @Test
  public void convertToExcelDataTest() throws Exception {
    ...
    // Act
    CellData actual = booleanBooleanConverter.convertToExcelData(value, contentProperty, globalConfiguration);
