...
public class BooleanStringConverter_convertToExcelDataTest_1_Test {
  @Test
  public void convertToExcelDataTest() throws Exception {
    ...
    // Act
    CellData actual = booleanStringConverter.convertToExcelData(value, contentProperty, globalConfiguration);
