...
public class LongBooleanConverter_convertToExcelDataTest_2_Test {
  @Test
  public void convertToExcelDataTest() throws Exception {
    ...
    // Act
    CellData actual = longBooleanConverter.convertToExcelData(value, contentProperty, globalConfiguration);
