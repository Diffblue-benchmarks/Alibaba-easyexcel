...
public class LongNumberConverter_convertToExcelDataTest_3_Test {
  @Test
  public void convertToExcelDataTest() throws Exception {
    ...
    // Act
    CellData actual = longNumberConverter.convertToExcelData(value, contentProperty, globalConfiguration);
