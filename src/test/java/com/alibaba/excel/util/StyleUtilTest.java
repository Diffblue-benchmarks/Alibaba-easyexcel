...
//  @Test
//  public void buildContentCellStyleInputNotNullNotNullOutputNotNull9991d4287377b801f93() {
//
//    // Arrange
...
//
//    // Act
//    final CellStyle actual = StyleUtil.buildContentCellStyle(arg0, arg1);
//
//    // Assert side effects
...
//    Assert.assertEquals(54, ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getXfpos());
//    Assert.assertEquals(62, ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getBspos());
...
//    Assert.assertEquals(69, ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().size());
...
//    Assert.assertEquals((short) 0, ((ExtendedFormatRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(54)).getIndentionOptions());
//    Assert.assertEquals((short) 0, ((ExtendedFormatRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(54)).getFontIndex());
//    Assert.assertEquals((short) 1, ((ExtendedFormatRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(54)).getCellOptions());
//    Assert.assertEquals((short) 1032, ((ExtendedFormatRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(54)).getPaletteOptions());
//    Assert.assertEquals((short) 0, ((ExtendedFormatRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(54)).getFormatIndex());
//    Assert.assertEquals(1032, ((ExtendedFormatRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(54)).getAdtlPaletteOptions());
...
//    Assert.assertEquals(0, ((BoundSheetRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(62)).getPositionOfBof());
//    Assert.assertEquals("Sheet1", ((BoundSheetRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(62)).getSheetname());
//    Assert.assertNotNull(((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(63));
//    Assert.assertEquals((short) 1, ((CountryRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(63)).getDefaultCountry());
//    Assert.assertEquals((short) 1, ((CountryRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(63)).getCurrentCountry());
//    Assert.assertNotNull(((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(64));
//    Assert.assertEquals((short) 1, ((SupBookRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(64)).getNumberOfSheets());
//    Assert.assertNotNull(((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(65));
//    Assert.assertEquals(Reflector.getInstanceField(((HSSFWorkbook) arg0).getWorkbook(), "sst"), ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(66));
//    Assert.assertNotNull(((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(67));
//    Assert.assertArrayEquals(new ExtSSTRecord.InfoSubRecord[]{ }, ((ExtSSTRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(67)).getInfoSubRecords());
//    Assert.assertNotNull(((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(68));
...
//    Assert.assertEquals((short) 21, ((HSSFCellStyle) actual).getIndex());
//
//  }

//failed_compile   // Test written by Diffblue Cover
//  @Test
//  public void buildDefaultCellStyleInputNotNullOutputNotNull999cb3e0b4558725e8a() {
//
//    // Arrange
//    final HSSFWorkbook arg0 = new HSSFWorkbook();
//
//    // Act
//    final CellStyle actual = StyleUtil.buildDefaultCellStyle(arg0);
//
//    // Assert side effects
//    Assert.assertNotNull(arg0);
//    Assert.assertNotNull(((HSSFWorkbook) arg0).getUDFFinder());
...
//    Assert.assertEquals((short) 8384, ((ExtendedFormatRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(53)).getFillPaletteOptions());
//    Assert.assertNotNull(((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(54));
//    Assert.assertEquals((short) 4369, ((ExtendedFormatRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(54)).getBorderOptions());
//    Assert.assertEquals((short) -20480, ((ExtendedFormatRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(54)).getIndentionOptions());
//    Assert.assertEquals((short) 0, ((ExtendedFormatRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(54)).getFontIndex());
//    Assert.assertEquals((short) 1, ((ExtendedFormatRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(54)).getCellOptions());
//    Assert.assertEquals((short) 1032, ((ExtendedFormatRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(54)).getPaletteOptions());
//    Assert.assertEquals((short) 0, ((ExtendedFormatRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(54)).getFormatIndex());
//    Assert.assertEquals(67109896, ((ExtendedFormatRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(54)).getAdtlPaletteOptions());
//    Assert.assertEquals((short) 26, ((ExtendedFormatRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(54)).getAlignmentOptions());
//    Assert.assertEquals((short) 8214, ((ExtendedFormatRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(54)).getFillPaletteOptions());
//    Assert.assertNotNull(((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(55));
//    Assert.assertNull(((StyleRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(55)).getName());
//    Assert.assertNotNull(((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(56));
//    Assert.assertNull(((StyleRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(56)).getName());
...
//failed_compile   // Test written by Diffblue Cover
//  @Test
//  public void buildHeadCellStyleInputNotNullNotNullOutputNotNull999aa38cb07b97f9d08() {
//
//    // Arrange
//    final HSSFWorkbook arg0 = new HSSFWorkbook();
//    final WriteCellStyle arg1 = new WriteCellStyle();
//
//    // Act
//    final CellStyle actual = StyleUtil.buildHeadCellStyle(arg0, arg1);
//
//    // Assert side effects
//    Assert.assertNotNull(arg0);
//    Assert.assertNotNull(((HSSFWorkbook) arg0).getUDFFinder());
...
//    Assert.assertEquals(7, ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getTabpos());
//    Assert.assertEquals(55, ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getXfpos());
//    Assert.assertEquals(63, ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getBspos());
//    Assert.assertEquals(0, ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getExternsheetPos());
//    Assert.assertNotNull(((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords());
//    Assert.assertEquals(70, ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().size());
//    Assert.assertNotNull(((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(0));
//    Assert.assertEquals(5, ((BOFRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(0)).getType());
//    Assert.assertEquals(1536, ((BOFRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(0)).getVersion());
//    Assert.assertEquals(65, ((BOFRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(0)).getHistoryBitMask());
...
//    Assert.assertNotNull(((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(62));
//    Assert.assertNotNull(((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(63));
//    Assert.assertEquals(0, ((BoundSheetRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(63)).getPositionOfBof());
//    Assert.assertEquals("Sheet1", ((BoundSheetRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(63)).getSheetname());
//    Assert.assertNotNull(((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(64));
//    Assert.assertEquals((short) 1, ((CountryRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(64)).getDefaultCountry());
//    Assert.assertEquals((short) 1, ((CountryRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(64)).getCurrentCountry());
//    Assert.assertNotNull(((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(65));
//    Assert.assertEquals((short) 1, ((SupBookRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(65)).getNumberOfSheets());
//    Assert.assertNotNull(((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(66));
//    Assert.assertEquals(Reflector.getInstanceField(((HSSFWorkbook) arg0).getWorkbook(), "sst"), ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(67));
//    Assert.assertNotNull(((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(68));
//    Assert.assertArrayEquals(new ExtSSTRecord.InfoSubRecord[]{ }, ((ExtSSTRecord) ((HSSFWorkbook) arg0).getWorkbook().getWorkbookRecordList().getRecords().get(68)).getInfoSubRecords());
