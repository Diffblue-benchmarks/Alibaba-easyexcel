...
public class ByteBooleanConverterDiffblueTest {
  @Test(timeout=10000)
  public void supportExcelTypeKeyTest() {
    // Arrange, Act and Assert
    assertEquals(CellDataTypeEnum.BOOLEAN, (new ByteBooleanConverter()).supportExcelTypeKey());
  }
  ...
  public void convertToExcelDataTest2() {
    ...
    // Act
    CellData actualConvertToExcelDataResult = byteBooleanConverter.convertToExcelData(Byte.valueOf((byte) 1),
